...
| `tx_mode(mode)`                    | select between B (11b), G (11g), MM (11n mixed mode) & GF (11n Greenfield) and sets the rate|`mode_802_11`:<br>'[B]\_[1, 2, 5_5, 11]Mbps'<br>'[G]\_[6, 9, 12, 18, 24, 36, 48, 54]Mbps'<br>'[MM, GF]\_MCS[0-7]'<br>**Examples**: 'B_1Mbps', 'LEG_54Mbps', 'GF_MCS5'
