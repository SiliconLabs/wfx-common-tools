...
| `tx_backoff(mod, backoff_level)`   | set power backoff for one group of modulations. All other backoff 0. |`mode_802_11`:<br>  '[B]\_[1, 2, 5_5, 11]Mbps'<br>'[G]\_[6, 9, 12, 18, 24, 36, 48, 54]Mbps'<br>'[MM, GF]\_MCS[0-7]'<br><br>**Examples**: 'B_1Mbps', 'G_54Mbps', 'GF_MCS5'<br>`backoff_level`: [0:63.75] dB
...
| `tx_mode(mode)`                    | select between MM (mixed mode) & GF (Greenfield) and sets the rate|`mode_802_11`:<br>'[B]\_[1, 2, 5_5, 11]Mbps'<br>'[G]\_[6, 9, 12, 18, 24, 36, 48, 54]Mbps'<br>'[MM, GF]\_MCS[0-7]'<br>**Examples**: 'B_1Mbps', 'G_54Mbps', 'GF_MCS5'
